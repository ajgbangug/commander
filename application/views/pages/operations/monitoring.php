<?php echo form_open('action/enqueue', array('class' => 'operation')); ?>
    ...
    <div class="input-prepend input-append">
        ...
        <div class="btn-group" data-toggle="buttons-radio">
            <button class="btn task_choice" type="button" value="update_info">Update information</button>
            <button class="btn task_choice" type="button" value="remove_node">Remove from list</button>
        </div>
